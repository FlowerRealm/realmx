...
//! includes the default, plan, and Ultra Work presets with their default model and
//! reasoning effort settings, which keeps the API contract visible in one place.
